...
public class InMemoryBuchRepository implements BuchRepository {
    ...
    public Buch save(Buch buch) {
        ...
        Buch persistedBuch = new Buch(buch.getId() == null ? currentId : buch.getId(), buch.getTitel(),
                buch.getAutor(), buch.getIsbn(), buch.isAusgeliehen(), buch.getAusgeliehenVon());
    ...
    private void initialize() {
        ...
        buchStore.put(currentId,
                new Buch(currentId, "Die 13½ Leben des Käpt’n Blaubär", "Walter Moers", "978-3-328-60120-3", false, Optional.empty()));
        currentId++;
        buchStore.put(currentId,
                new Buch(currentId, "Die kleine Raupe Nimmersatt", "Eric Carle", "978-3-7891-6764-5", false, Optional.empty()));
        currentId++;
        buchStore.put(currentId,
                new Buch(currentId, "Der Räuber Hotzenplotz", "Otfried Preußler", "978-3-7891-2025-1", false, Optional.empty()));
        currentId++;
        buchStore.put(currentId,
                new Buch(currentId, "Das Sams", "Paul Maar", "978-3-7891-2026-8", false, Optional.empty()));
        currentId++;
        buchStore.put(currentId,
                new Buch(currentId, "Pippi Langstrumpf", "Astrid Lindgren", "978-3-7891-2027-5", false, Optional.empty()));
        currentId++;
        buchStore.put(currentId,
                new Buch(currentId, "Die wilden Kerle", "Joachim Masannek", "978-3-401-02260-7", false, Optional.empty()));
    }
}
